...
public:
    ...
    std::uint64_t getReplyToCommentId() const noexcept { return replyToCommentId_; }
    const std::string& getReplyToUserName() const noexcept { return replyToUserName_; }
    ...
    void setReplyToCommentId(std::uint64_t value) noexcept { replyToCommentId_ = value; }
    void setReplyToUserName(std::string value) { replyToUserName_ = std::move(value); }
...
private:
    ...
    std::uint64_t replyToCommentId_{0};
    std::string replyToUserName_;
    std::string content_;
